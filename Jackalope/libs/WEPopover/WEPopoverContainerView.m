...
+(WEPopoverContainerViewProperties*)standardProperties{
...
- (id)initWithSize:(CGSize)theSize anchorRect:(CGRect)anchorRect displayArea:(CGRect)displayArea {
    return [self initWithSize:theSize anchorRect:anchorRect displayArea:displayArea permittedArrowDirections:(UIPopoverArrowDirectionUp | UIPopoverArrowDirectionDown) properties:[WEPopoverContainerViewProperties standardProperties]];
}
